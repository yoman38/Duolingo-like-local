from PySide6.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout, QComboBox,
                               ...
                               QSpinBox, QColorDialog, QCheckBox, QTabWidget, QScrollArea, QGraphicsView, QGraphicsScene, QGraphicsEllipseItem, QGraphicsTextItem, QTextBrowser, QGraphicsLineItem, QFileDialog, QDialog)
...
class Bubble:
    ...
    def to_dict(self):
        bubble_dict = {
            ...
            'x': self.x,
            'y': self.y,
            'color': self.color.name(),  # Convert QColor to its name string
...
class CourseCreation(QWidget):
    ...
    def upload_pdf(self):
        ...
        if filePath:
            self.pdf_path = filePath  # Assume self.pdf_path is initialized in __init__
            self.content_input.insertHtml(f'<a href="{filePath}">Open PDF</a>')
