from PySide6.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout, QComboBox,
                               ...
                               QSpinBox, QColorDialog, QCheckBox, QTabWidget, QScrollArea, QGraphicsView, QGraphicsScene, QGraphicsEllipseItem, QTextBrowser)
...
class CourseCreation(QWidget):
    def __init__(self):
        ...
        self.canvas.setFixedWidth(800)  # Increased width
        self.canvas.setFixedHeight(600)  # Increased height
    ...
    def save_course(self):
        ...
        new_bubble = Bubble(title, content, x=50, y=50)
    ...
    def update_bubble_canvas(self):
        ...
        for bubble in self.bubbles:
            ...
            ellipse.setBrush(QBrush(bubble.color))
