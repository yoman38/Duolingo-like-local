...
class CourseCreation(QWidget):
    ...
    def back_to_main_canvas(self):
        # Reset self.bubbles to the main list of bubbles
        # (You'll need to keep track of this list separately)
        self.bubbles = self.main_bubbles
        self.update_bubble_canvas()
